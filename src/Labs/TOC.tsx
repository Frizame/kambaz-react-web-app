...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link href="https://github.com/Frizame/kambaz-react-web-app/tree/P" target="_blank"> React Repo </Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link href="https://github.com/Frizame/kambaz-node-server-app/tree/P" target="_blank"> Node Repo </Nav.Link> </Nav.Item>
    </Nav>
  );
}
